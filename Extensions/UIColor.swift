...
extension UIColor
{
    ...
    static func UnitColor(_ Value: CGFloat, Alpha: CGFloat = 1.0, Channel: PickerColorChannels) -> UIColor
    {
        var Final: UIColor = UIColor()
        
        switch Channel
        {
            case .Red, .Green, .Blue:
                Final = UIColor(red: Value, green: Value, blue: Value, alpha: Alpha)
                
            case .Hue:
                Final = UIColor(hue: Value, saturation: 0.5, brightness: 1.0, alpha: Alpha)
                
            case .Saturation:
                Final = UIColor(hue: Value, saturation: Value, brightness: 1.0, alpha: Alpha)
                
            case .Brightness:
                Final = UIColor(hue: Value, saturation: Value, brightness: Value, alpha: Alpha)
                
            case .Cyan:
                let (R, G, B) = CMYKtoRGB(Cyan: Value, Magenta: 0.0, Yellow: 0.0, Black: 0.0)
                Final = UIColor(red: R, green: G, blue: B, alpha: Alpha)
